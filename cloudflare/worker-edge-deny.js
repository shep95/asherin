...
const CSP = [
  ...
  "connect-src 'self' wss://*.supabase.co https://*.supabase.co https://*.supabase.in https://api.stripe.com https://ipapi.co https://api.ipify.org https://haveibeenpwned.com https://cloudflare-dns.com https://nominatim.openstreetmap.org https://api.open-meteo.com https://overpass-api.de https://overpass.kumi.systems https://router.project-osrm.org https://server.arcgisonline.com https://*.googleapis.com https://*.google.com https://*.elevenlabs.io https://crt.sh https://api.hyperliquid.xyz https://api.firecrawl.dev https://cdn.jsdelivr.net https://*.skyvdn.com https://*.dot.ca.gov https://s3-eu-west-1.amazonaws.com https://api.weather.gov https://earthquake.usgs.gov https://waterservices.usgs.gov https://air-quality-api.open-meteo.com https://api.panoramax.xyz https://hazards.fema.gov https://aviationweather.gov https://services3.arcgis.com https://opensky-network.org https://tile.openstreetmap.org https://storage.googleapis.com https://vpic.nhtsa.dot.gov https://api.nhtsa.gov https://opendata.rdw.nl https://geocoding.geo.census.gov https://api.tidesandcurrents.noaa.gov https://geo.txdps.state.tx.us https://gis.fdle.state.fl.us https://haveibeenpwned.com https://api.pwnedpasswords.com",
