  ...
  public: {
    Tables: {
      ...
      vibe_imager_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "vibe_imager_messages_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "vibe_imager_projects"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "vibe_imager_messages_version_id_fkey"
            columns: ["version_id"]
            isOneToOne: false
            referencedRelation: "vibe_imager_versions"
            referencedColumns: ["id"]
          },
        ]
      }
      vibe_imager_projects: {
        Row: {
          created_at: string
          id: string
          name: string
      ...
      vibe_imager_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "vibe_imager_versions_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "vibe_imager_versions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vibe_imager_versions_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "vibe_imager_projects"
            referencedColumns: ["id"]
