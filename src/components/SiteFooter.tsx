          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-12 px-8 py-14 sm:px-14 sm:py-16">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <a href="https://x.com/asherin_elion" target="_blank" rel="noopener noreferrer" className="group flex h-9 w-9 items-center justify-center rounded-full border border-[hsl(43_90%_60%)]/30 bg-card/30 text-[hsl(43_90%_60%)] transition-all hover:border-[hsl(43_90%_60%)]/60 hover:scale-105" aria-label="X / Twitter — Backup">
                  <Twitter className="h-3.5 w-3.5" />
                </a>
