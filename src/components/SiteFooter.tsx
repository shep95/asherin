          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-border/15">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://x.com/aureon_elion" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-zophiel-gold hover:text-zophiel-gold/80 transition-colors" aria-label="X / Twitter — Backup">
                  <Twitter className="h-4 w-4" />
