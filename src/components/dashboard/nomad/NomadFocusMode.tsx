  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background/95 backdrop-blur-xl flex flex-col animate-fade-in">
      ...
      <div className="flex-1 overflow-y-auto px-8 py-8">
        <div className="max-w-3xl mx-auto prose prose-invert prose-lg font-extralight [&_p]:leading-relaxed [&_p]:text-foreground/90 [&_h1]:font-light [&_h2]:font-light [&_h3]:font-light [&_strong]:text-foreground [&_a]:text-foreground">
