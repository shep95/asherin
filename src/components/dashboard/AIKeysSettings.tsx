...
export const AI_PROVIDERS: ProviderConfig[] = [
  {
    ...
    models: [
      { id: "gemini-3.1-pro", name: "Gemini 3.1 Pro", description: "Most advanced reasoning, 1M context" },
      { id: "gemini-3.1-flash-lite", name: "Gemini 3.1 Flash Lite", description: "Fastest & cheapest, high-volume" },
      ...
      { id: "gemini-2.5-flash-lite", name: "Gemini 2.5 Flash Lite", description: "Budget-friendly Gemini" },
    ],
  },
  {
    id: "openai",
    ...
    models: [
      { id: "gpt-5.4", name: "GPT-5.4", description: "Most capable, 1M context" },
      { id: "gpt-5.3", name: "GPT-5.3 Instant", description: "Fast everyday model, 400K context" },
      { id: "gpt-5.2", name: "GPT-5.2", description: "Strong reasoning, configurable effort" },
      { id: "gpt-5-mini", name: "GPT-5 Mini", description: "Cost-efficient for defined tasks" },
      { id: "gpt-4.1", name: "GPT-4.1", description: "Best coding model" },
      { id: "gpt-4.1-mini", name: "GPT-4.1 Mini", description: "Fast & affordable coding" },
  ...
  },
  {
    ...
    models: [
      { id: "claude-opus-4-6", name: "Claude Opus 4.6", description: "Most powerful, 1M context, 128K output" },
      { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", description: "Best balance, 1M context" },
      { id: "claude-sonnet-4-20250514", name: "Claude Sonnet 4", description: "Strong all-rounder" },
  ...
  },
  {
    ...
    models: [
      { id: "grok-4", name: "Grok 4", description: "World-class reasoning, 256K context" },
      { id: "grok-4-fast-reasoning", name: "Grok 4 Fast", description: "Fast reasoning, 2M context" },
      { id: "grok-code-fast-1", name: "Grok Code", description: "Agentic coding model" },
      { id: "grok-3", name: "Grok 3", description: "Reliable all-rounder" },
    ],
  },
  {
    id: "mistral",
    ...
    models: [
      { id: "mistral-medium-latest", name: "Mistral Medium 3.1", description: "Frontier multimodal" },
      { id: "mistral-large-latest", name: "Mistral Large", description: "Most capable text model" },
