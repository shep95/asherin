import { X, Play, Trash2, GripVertical, Clock } from "lucide-react";
...
const MessageQueuePanel = ({ items, onRemove, onClear, onProcessNow }: MessageQueuePanelProps) => {
            ...
            <div className="flex items-center gap-1">
              {onProcessNow && (
                <button
                  ...
                  className="p-1.5 rounded-lg text-muted-foreground/50 hover:text-foreground hover:bg-foreground/5 transition-all"
                  title="Process now"
                >
          ...
          <div className="max-h-32 overflow-y-auto">
            {items.map((item, i) => (
              ...
              >
                ...
                <Clock className="h-3 w-3 text-accent/40 shrink-0" />
