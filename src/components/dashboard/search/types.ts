...
export type SearchMode = 'web' | 'news' | 'academic' | 'code' | 'data' | 'docs' | 'deep' | 'imagine' | 'extract' | 'audit' | 'face' | 'darkweb' | 'leaks' | 'archive' | 'vpn' | 'dataengine' | 'harvest' | 'scribd' | 'dork' | 'ghostchain';
