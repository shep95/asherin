import { Globe, Newspaper, GraduationCap, Code, BarChart3, FileText, Brain, Image as ImageIcon, Crosshair, ShieldAlert } from "lucide-react";
...
const modes: { id: SearchMode; label: string; icon: React.ReactNode; accent?: boolean }[] = [
  ...
  { id: "audit", label: "Code Audit", icon: <ShieldAlert className="h-3.5 w-3.5" />, accent: true },
