import { Globe, Newspaper, GraduationCap, Code, BarChart3, FileText, Brain, Image as ImageIcon, Crosshair, ShieldAlert, Scan, Skull, FileArchive, Archive } from "lucide-react";
...
const modes: { id: SearchMode; label: string; icon: React.ReactNode; accent?: boolean }[] = [
  ...
  { id: "archive", label: "Archive.org", icon: <Archive className="h-3.5 w-3.5" />, accent: true },
