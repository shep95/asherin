...
type ModeDef = { id: SearchMode; label: string; icon: React.ReactNode };

// The shipped search surfaces. Retired tools are not listed and are not reachable.
const modes: ModeDef[] = [
    ...
    <div className="flex flex-wrap items-center gap-1">
      {modes.map((m) => (
        <button
          ...
          className={`flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[11px] font-light whitespace-nowrap transition-all border ${
            active === m.id
