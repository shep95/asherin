...
const CommandPalette = ({ open, onClose, onNewConversation, onViewChange, onModeChange, onFocusMode }: CommandPaletteProps) => {
  ...
  const commands: Command[] = [
    ...
    { id: "geospatial", label: "Intelligence Property Map", category: "Navigation", icon: Globe, action: wrap("geospatial", () => onViewChange("geospatial")), keywords: ["map", "location", "property", "land", "parcel", "real estate"] },
