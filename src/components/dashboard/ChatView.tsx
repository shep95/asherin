...
const mockSuggestions = [
  "Explain the implications further",
  "Give me a counterargument",
  "How does this compare to alternatives?",
];

const ChatView = ({ conversation, onSendMessage, mode, onModeChange }: ChatViewProps) => {
  ...
  const showSuggestions = lastMsg?.role === "assistant";
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4">
        {conversation.messages.length === 0 ? (
          ...
          <div className="mx-auto max-w-3xl space-y-4 py-4">
            ...
            {showSuggestions && (
              <FollowUpSuggestions suggestions={mockSuggestions} onSelect={(s) => onSendMessage(s)} />
            )}
