...
const Header = () => {
  ...
  return (
    <>
              ...
              {isAsherRoute ? (
                ...
                <>
                  {!loading && user ? (
                    ...
                    >
                      <span className="font-mono text-[8px] tracking-[0.15em] text-foreground/40 relative z-10">
                        02
                      </span>
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="group relative flex items-center gap-2 px-5 py-2.5 text-[11px] font-light tracking-[0.22em] uppercase text-background overflow-hidden"
                      >
                        <span
                          aria-hidden
                ...
                <div className="relative flex flex-col gap-2">
                  {!loading && user ? (
                    ...
                    <>
                      ...
                      <button
                        onClick={() => openAuth(true)}
                        className="rounded-lg border border-foreground/20 px-4 py-3 min-h-[48px] flex items-center justify-center text-sm font-light tracking-wide text-foreground transition-colors hover:bg-foreground/10"
                      >
                        Log in
                      </button>
                    </>
      ...
      {showAuth && <AuthOverlay isLogin={isLogin} setIsLogin={setIsLogin} onClose={() => setShowAuth(false)} />}
    </>
  );
};
