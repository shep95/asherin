...
const features = [
  ...
  { name: "Zophiel Search Engine", chat: true, aureon: true, pro: true, lifetime: false },
  { name: "Intelligence Notebooks", chat: true, aureon: true, pro: true, lifetime: false },
  ...
  { name: "E-Book Generator", chat: true, aureon: true, pro: true, lifetime: false },
  { name: "Zahten Agent Forge", chat: true, aureon: true, pro: true, lifetime: false },
  { name: "Guardian Vault", chat: true, aureon: true, pro: true, lifetime: false },
  { name: "Aureon IDE", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Persistent memory", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Code Snippets Vault", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Custom Personas", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Vibe Imager", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Imagine To Code", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Reverse Engineering", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "File Scrapper", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Cipher Toolkit", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Whiteboard", chat: false, aureon: true, pro: true, lifetime: false },
  { name: "Google Intelligence Suite", chat: false, aureon: false, pro: true, lifetime: false },
  { name: "NOMAD Public Intelligence", chat: false, aureon: false, pro: true, lifetime: false },
  { name: "Azplen Data Intelligence", chat: false, aureon: false, pro: true, lifetime: false },
  { name: "Daily Intelligence Briefings", chat: false, aureon: false, pro: true, lifetime: false },
  ...
  { name: "ZANOEM Design Lab", chat: false, aureon: false, pro: true, lifetime: false },
