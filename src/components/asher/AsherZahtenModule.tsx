          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs font-extralight text-muted-foreground/85 leading-relaxed">
                Zahten orchestrates every Asher and Aureon brain — durable workflows route across the full
                cognitive stack. To run, operators must supply their own LLM API key once in
                <span className="text-foreground/90"> Settings → Bring Your Own LLM Key</span>. The same key
                powers every tab; no per-tab configuration.
              </p>
            </div>
