...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "zerlal", icon: Shield, label: "Asherin Cyber", pro: true, desc: "Passive domain context and public advisory intelligence." },
      { id: "eye", icon: Globe, label: "Asherin Eye", pro: true, desc: "Live public spatial layers with aircraft, disasters, and public cameras." },
      { id: "defender", icon: Shield, label: "Asherin Defender", pro: true, desc: "Security posture guidance for the browser and owned device." },
