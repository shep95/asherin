...
export const NAV_INTENTS: NavIntent[] = [
  ...
  // INVESTIGATE
  { view: "search", label: "asherin.search", codename: "sourced search", blurb: "sourced search with credibility tiers", keywords: ["search", "zophiel", "osint", "web", "dark web", "leaks", "archives"], group: "Investigate" },
  { view: "zerlal", label: "asherin.recon", codename: "domain + infra", blurb: "domain and infrastructure recon", keywords: ["recon", "zerlal", "domain", "ports", "cve", "cyber", "vulnerability"], group: "Investigate" },
  { view: "zacoon", label: "asherin.autoweb", codename: "logged web runs", blurb: "autonomous web runs, every step logged", keywords: ["autoweb", "zacoon", "agent", "browse", "crawl", "automation"], group: "Investigate" },
  { view: "google", label: "asherin.google", codename: "your accounts", blurb: "your connected google accounts, read on request", keywords: ["google", "gmail", "calendar", "drive", "accounts", "mesh"], group: "Investigate" },
  { view: "zaxin", label: "asherin.field", codename: "ble + optical", blurb: "browser-native bluetooth and field tools", keywords: ["field", "zaxin", "ble", "bluetooth", "signal", "device"], group: "Investigate" },
  { view: "knowledge-vault", label: "asherin.knowledge", codename: "private corpus", blurb: "private files asherin can cite", keywords: ["knowledge", "vault", "corpus", "rag", "documents", "cite"], group: "Investigate" },
  { view: "file-scrapper", label: "asherin.extract", codename: "document text", blurb: "pull text and tables out of documents", keywords: ["extract", "scrapper", "scraper", "parse", "pdf", "ocr", "file"], group: "Investigate" },
  { view: "briefing", label: "asherin.briefings", codename: "scheduled reading", blurb: "scheduled reading, sourced", keywords: ["briefing", "briefings", "daily", "digest", "news"], group: "Investigate" },

  // ANALYZE
  { view: "azplen", label: "asherin.data", codename: "datasets", blurb: "datasets, analysis and charts", keywords: ["data", "azplen", "dataset", "ontology", "chart", "table"], group: "Analyze" },
  { view: "axrlen", label: "asherin.forecast", codename: "scenarios", blurb: "scenario forecasting with intervals", keywords: ["forecast", "axrlen", "prediction", "scenario", "probability"], group: "Analyze" },
  { view: "zeeion", label: "asherin.finance", codename: "cost forensics", blurb: "financial analysis on your own numbers", keywords: ["finance", "zeeion", "cost", "waste", "spend", "budget"], group: "Analyze" },
  { view: "timeseries", label: "asherin.timeseries", codename: "temporal", blurb: "temporal analysis and anomalies", keywords: ["timeseries", "time series", "trend", "anomaly", "temporal"], group: "Analyze" },
  { view: "pattern-analysis", label: "asherin.patterns", codename: "recognition", blurb: "pattern recognition over a dataset", keywords: ["pattern", "patterns", "recognition", "cluster"], group: "Analyze" },
  { view: "notebooks", label: "asherin.notebooks", codename: "sessions", blurb: "saved analysis sessions", keywords: ["notebook", "notebooks", "sql", "session", "query"], group: "Analyze" },
  { view: "stats", label: "asherin.stats", codename: "your usage", blurb: "your own usage. nothing benchmarked", keywords: ["stats", "usage", "metrics", "tokens"], group: "Analyze" },
  { view: "audit", label: "asherin.audit", codename: "activity log", blurb: "access and activity log", keywords: ["audit", "log", "activity", "access", "history"], group: "Analyze" },

  // BUILD
  { view: "ide", label: "asherin.ide", codename: "editor", blurb: "read, edit and run code with diffs before apply", keywords: ["ide", "code", "editor", "repo", "git", "terminal"], group: "Build" },
  { view: "zahten", label: "asherin.agents", codename: "agent forge", blurb: "build and publish an agent", keywords: ["agent", "agents", "zahten", "forge", "workflow", "deploy"], group: "Build" },
  { view: "snippets", label: "asherin.snippets", codename: "saved code", blurb: "saved code you reuse", keywords: ["snippet", "snippets", "code", "reuse"], group: "Build" },
  { view: "zali", label: "asherin.design", codename: "design lab", blurb: "design exploration", keywords: ["design", "zali", "ui", "lab", "sketch"], group: "Build" },
  { view: "community", label: "asherin.community", codename: "shared room", blurb: "shared prompts and rooms", keywords: ["community", "forum", "shared", "people"], group: "Build" },
  { view: "bug-reports", label: "asherin.bugs", codename: "your reports", blurb: "what you reported, and its state", keywords: ["bug", "bugs", "report", "issue", "broken"], group: "Build" },

  // CREATE
  { view: "slideshow", label: "asherin.slides", codename: "decks", blurb: "prompt a deck, keep the file", keywords: ["slides", "slideshow", "deck", "presentation"], group: "Create" },
  { view: "ebook", label: "asherin.ebook", codename: "long form", blurb: "long-form writing to a finished file", keywords: ["ebook", "book", "chapters", "write"], group: "Create" },
  { view: "gematria", label: "asherin.gematria", codename: "letter values", blurb: "letter-value arithmetic and matches", keywords: ["gematria", "numerology", "letters", "values"], group: "Create" },
  { view: "vedic-astrology", label: "asherin.vedic", codename: "transits", blurb: "moon-driven transits and timing", keywords: ["vedic", "astrology", "transit", "dasha", "chart"], group: "Create" },
];
