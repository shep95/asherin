...
export const NAV_INTENTS: NavIntent[] = [
  ...
  },
  {
    ...
    keywords: ["recon", "zerlal", "domain", "ports", "cve", "cyber", "vulnerability"],
    group: "Investigate",
  },
  {
    view: "zacoon",
    label: "asherin.autoweb",
    codename: "logged web runs",
    blurb: "autonomous web runs, every step logged",
    keywords: ["autoweb", "zacoon", "agent", "browse", "crawl", "automation"],
    group: "Investigate",
  },
  {
    view: "google",
  ...
  },
  {
    view: "zaxin",
    label: "asherin.field",
    codename: "ble + optical",
    blurb: "browser-native bluetooth and field tools",
    keywords: ["field", "zaxin", "ble", "bluetooth", "signal", "device"],
    group: "Investigate",
  },
  {
  ...
  {
    view: "axrlen",
    label: "asherin.forecast",
    codename: "scenarios",
    blurb: "scenario forecasting with intervals",
    keywords: ["forecast", "axrlen", "prediction", "scenario", "probability"],
    group: "Analyze",
  },
  {
    view: "zeeion",
    label: "asherin.finance",
    codename: "cost forensics",
    blurb: "financial analysis on your own numbers",
    keywords: ["finance", "zeeion", "cost", "waste", "spend", "budget"],
    group: "Analyze",
  },
  {
    view: "timeseries",
    label: "asherin.timeseries",
    codename: "temporal",
    blurb: "temporal analysis and anomalies",
    keywords: ["timeseries", "time series", "trend", "anomaly", "temporal"],
    group: "Analyze",
  },
  {
    ...
    blurb: "pattern recognition over a dataset",
    keywords: ["pattern", "patterns", "recognition", "cluster"],
    group: "Analyze",
  },
  {
    view: "notebooks",
    ...
    codename: "sessions",
    blurb: "saved analysis sessions",
    keywords: ["notebook", "notebooks", "sql", "session", "query"],
    group: "Analyze",
  },
  {
    view: "stats",
    label: "asherin.stats",
    codename: "your usage",
    blurb: "your own usage. nothing benchmarked",
    keywords: ["stats", "usage", "metrics", "tokens"],
    group: "Analyze",
  },
  {
    view: "audit",
    label: "asherin.audit",
    codename: "activity log",
    blurb: "access and activity log",
    keywords: ["audit", "log", "activity", "access", "history"],
    group: "Analyze",
  },
