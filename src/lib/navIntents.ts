...
export const NAV_INTENTS: NavIntent[] = [
  ...
  { view: "google", label: "Cloud Intelligence", codename: "Google Mesh", blurb: "Your Google accounts as a sensor array — voiceprint, places, attention, relationships, commitments, ghostwriting", keywords: ["google", "gmail", "email", "calendar", "voiceprint", "ghostwrite", "location history", "screentime", "attention", "commitments", "mesh"], group: "Investigate", access: "pro" },
