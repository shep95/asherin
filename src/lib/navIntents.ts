...
export const NAV_INTENTS: NavIntent[] = [
  ...
  { view: "vibe-video", label: "Edit & Generate Video", codename: "Vibe Video", blurb: "Conversational AI video editing", keywords: ["video", "clip", "edit video", "film"], group: "Create", access: "pro" },
  ...
  { view: "zerlal", label: "Cyber Security", codename: "Zerlal", blurb: "Threat analysis, vulnerability detection, defense", keywords: ["security", "cyber", "vulnerability", "exploit", "hack", "threat", "scan", "pentest"], group: "Investigate", access: "pro" },
  ...
  { view: "agents", label: "Automated Agents", codename: "Agents", blurb: "Schedule tasks on autopilot", keywords: ["agent", "automation", "schedule", "cron", "bot"], group: "Build", access: "pro" },
