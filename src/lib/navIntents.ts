...
export const NAV_INTENTS: NavIntent[] = [
  ...
  { view: "zaxin", label: "Network Defense Grid", codename: "Zaxin", blurb: "NIDS, PCAP, threat hunting, endpoint, case management", keywords: ["zaxin", "security onion", "nids", "suricata", "zeek", "wazuh", "pcap", "hunt", "siem", "soc"], group: "Investigate" },
