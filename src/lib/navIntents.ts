...
export const NAV_INTENTS: NavIntent[] = [
  ...
  {
    view: "shepherd",
    label: "asherin.shepherd",
    codename: "asherin.shepherd",
    blurb: "evidence graph — anchor gate first, tier ceilings, a dependency chain on every finding",
    keywords: [
      "shepherd",
      "evidence",
      "graph",
  ...
  },
  {
    ...
    keywords: ["zaxin", "field", "ble", "bluetooth", "signal", "device"],
    group: "Investigate",
  },
  {
