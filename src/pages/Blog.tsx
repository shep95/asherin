...
export const BLOG_POSTS: Post[] = [
  ...
  {
    slug: "/blog/eth-daily-predictions",
    title: "AXRLEN ETH Daily — Live Long/Short Forecast (auto-updated 07:00 EST)",
    dek: "Every morning at 07:00 EST AXRLEN publishes a 24-hour Ethereum long/short call with entry, stop loss, take profit, and live ETH price. Wins and losses tally automatically.",
    tag: "Live Prediction",
    published: new Date().toISOString(),
    readTime: "Live",
    featured: true,
  ...
  {
    slug: "/blog/crude-oil-daily-predictions",
    title: "AXRLEN Crude Oil Daily — Live Long/Short Forecast (auto-updated 07:00 EST)",
    dek: "Every morning at 07:00 EST AXRLEN publishes a 24-hour WTI Crude (CL=F) long/short call with entry, stop loss, take profit, and live front-month price. Wins and losses tally automatically.",
    tag: "Live Prediction",
    published: new Date().toISOString(),
    readTime: "Live",
    featured: true,
  ...
  {
    slug: "/blog/sp500-daily-predictions",
    title: "AXRLEN S&P 500 Daily — Live Long/Short Forecast (auto-updated 07:00 EST)",
    dek: "Every morning at 07:00 EST AXRLEN publishes a 24-hour S&P 500 (^GSPC / ES) long/short call with entry, stop loss, take profit, and live index level. Wins and losses tally automatically.",
    tag: "Live Prediction",
    published: new Date().toISOString(),
    readTime: "Live",
    featured: true,
  ...
  {
    slug: "/blog/nasdaq-daily-predictions",
    title: "AXRLEN NASDAQ 100 Daily — Live Long/Short Forecast (auto-updated 07:00 EST)",
    dek: "Every morning at 07:00 EST AXRLEN publishes a 24-hour NASDAQ 100 (^NDX / NQ) long/short call with entry, stop loss, take profit, and live index level. Wins and losses tally automatically.",
    tag: "Live Prediction",
    published: new Date().toISOString(),
    readTime: "Live",
    featured: true,
