      ...
      <div className="relative z-10 px-6 pt-32 pb-24">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="rounded-2xl border border-border/20 bg-card/30 backdrop-blur-md p-8 sm:p-12">
            <h1 className="text-3xl sm:text-4xl font-extralight tracking-wide text-foreground mb-2">
              Terms of Service
            </h1>
            <p className="text-sm font-extralight text-muted-foreground mb-12">
            ...
            <div className="space-y-10 text-sm font-extralight leading-relaxed text-muted-foreground">
              ...
              <section>
                ...
                <p>
                  ZIALIEL is an AI-powered platform providing uncensored responses, an elite coding engine, live web search, persistent memory across sessions, team workspace functionality, and multi-language output. The Service is offered at a single tier of $18/month with full access to all features from day one.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-3">
                  The Service operates on a single pricing model:
                </p>
                <ul className="space-y-2 ml-4">
                  <li>→ $18/month — full access to all features.</li>
                  <li>→ No free tier. No upsells. No hidden tiers.</li>
              ...
              <section>
                ...
                <p>
                  We strive for continuous uptime but do not guarantee uninterrupted access. The Service may be temporarily unavailable for maintenance, updates, or circumstances beyond our control. We are not liable for any loss resulting from service downtime.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We reserve the right to update these Terms at any time. Continued use of the Service after changes constitutes acceptance of the revised Terms. Material changes will be communicated through the platform.
                </p>
              </section>
