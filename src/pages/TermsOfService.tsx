          ...
          <div className="rounded-2xl border border-border/20 bg-card/30 backdrop-blur-md p-8 sm:p-12">
            ...
            <div className="space-y-10 text-sm font-extralight leading-relaxed text-muted-foreground">
              ...
              <section>
                ...
                <p className="mb-3">Asherin is an AI intelligence platform. Depending on your tier it provides uncensored chat, a coding engine and in-dashboard IDE, live web search (Zophiel), persistent memory, notebooks and generators, workspace collaboration, and the rooms behind the chat, which may include asherin.search, asherin.eye, asherin.arvision, asherin.defender, asherin.sentinel, asherin.health, asherin.data, asherin.cyber, asherin.google, asherin.ide, agents, knowledge, briefings and guardian vault. Which rooms exist may change.</p>
              ...
              <section>
                ...
                <ul className="space-y-2 ml-4">
                  <li>→ Asherin, <strong>$18/month</strong>, or a discounted 6-month term. Chat (Chat / Code / Research / Truth modes) with directive profiles, coding engine, multi-language output, response-depth control, and the rooms behind the chat at standard limits: asherin.search, asherin.eye, asherin.arvision (optical, spatial, eagle.eye), asherin.defender, asherin.sentinel, asherin.health, asherin.google, asherin.ide, agents, snippets, extract, briefings and pages, plus library, projects, memory, guardian vault, whiteboard, a limited team workspace and delete + export anytime. 60 messages per 3-hour window.</li>
                  <li>→ Asherin Pro, <strong>$79/month</strong>, or a discounted 6-month term. Everything in Asherin, plus asherin.data, asherin.cyber and asherin.knowledge, with raised ceilings: deeper asherin.search discovery and identity pivots, higher throughput with queue priority, more simultaneous eagle.eye cameras and longer evidence retention, the asherin.defender companion apply path and full scan, and a full team workspace with admin controls. 200 messages per 3-hour window.</li>
