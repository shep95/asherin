            ...
            <div className="space-y-6 text-sm font-extralight leading-relaxed text-foreground/85">
              ...
              <section>
                ...
                <ul className="mt-3 space-y-2 ml-4">
                  ...
                  <li className="flex items-start gap-2"><Lock className="h-3 w-3 mt-1 text-purple-400 shrink-0" /><span>The internal operational mechanics, algorithms, data processing pipelines, and analytical frameworks of the AZPLEN Data Intelligence Platform, NOMAD OSINT Engine, and Zophiel Search Engine.</span></li>
