        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6 items-start max-w-7xl mx-auto">
            ...
            <div className="rounded-2xl border border-accent/20 bg-accent/5 backdrop-blur-md p-7 sm:p-8 flex flex-col text-left">
              ...
              <p className="mt-3 text-sm font-extralight leading-relaxed text-muted-foreground">Permanent chat access with your own uncensored LLM model powered by ZOPHIEL intelligence. BYOK required.</p>
              ...
              <ul className="space-y-2.5 flex-1">
                {["Aureon Chat — permanent access", "Your own uncensored LLM model", "Powered by ZOPHIEL Intelligence", "BYOK required (8 providers)", "GPT-5.4, Opus 4.6, Gemini 3.1 Pro & more", "No Aureon default engine", "100 msgs / 3-hour window", "End-to-end encryption", "No expiry — lifetime means lifetime"].map(f => (
