    ...
    const schemas = [
      {
        ...
        data: {
          ...
          url: "https://asherin.com",
           description:
             "asherin is a sourced research workspace: chat, asherin.cyber, asherin.eye, asherin.defender, asherin.arvision, asherin.pages. $18/mo, $79/mo pro. honest about what it does not know.",
        },
      },
      {
        id: "home-faq-jsonld",
        ...
        <div className="mx-auto w-full max-w-5xl">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-sm font-extralight leading-relaxed text-muted-foreground">
              an asherin workspace you can open immediately. no account or subscription required.
            </p>
          </div>
        ...
        <div className="mx-auto w-full max-w-6xl">
          ...
          <div className="mx-auto mt-16 max-w-3xl space-y-3">
            {[
              {
                q: "what does the $18 plan include?",
                a: "chat with sources beside the answer, asherin.cyber, asherin.eye, asherin.defender, asherin.arvision, asherin.pages, a private vault, and memory that carries between sessions.",
              },
              {
                q: "what does pro add?",
