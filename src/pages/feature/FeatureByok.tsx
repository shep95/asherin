    ...
    <FeaturePageShell
      ...
      capabilities={[
        ...
        },
        {
          ...
          description:
            "Spend is invoiced by the model vendor, not Asherin. A typical operator BYOK bill at the API tier is ~$15-25/month on OpenAI vs $47/month on Asherin's managed Chat tier — see the cost comparison below.",
        },
        {
          icon: Lock,
