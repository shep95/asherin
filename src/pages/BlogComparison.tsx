...
const FAQ = [
  ...
  },
  {
    ...
    a: "Aureon is $18/month for the core platform — cheaper than ChatGPT Plus ($20/mo) and Claude Pro ($20/mo) and bundles search, code, memory, workspace and E2E encryption in one tier. Asherin Pro ($399/mo) adds the full intelligence suite (Azplen, NOMAD, advanced Briefings, Zophiel Pro and team collaboration). Enterprise is custom-priced.",
  },
  {
  ...
  },
  {
    ...
    a: "Two plans. Aureon at $18/month: chat, code, base Zophiel Search, persistent memory, workspace, E2E encryption, 60 messages per 3-hour window. Asherin Pro at $399/month: everything in Aureon plus Azplen data intelligence, NOMAD OSINT, advanced Briefings, Zophiel Pro with higher query limits and priority latency, full team collaboration, and 200 messages per 3-hour window. Enterprise (SSO/SAML, audit, dedicated capacity) is custom-priced.",
  },
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-28 pb-24 space-y-16">
        ...
        <article className="space-y-6">
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm font-extralight leading-relaxed text-foreground/85">
              Aureon is $18/month for the core platform and $399/month for Asherin Pro,
          ...
          <section className="rounded-2xl border border-border/30 bg-card/20 backdrop-blur-sm p-8 text-center space-y-4">
            ...
            <p className="text-sm font-extralight text-muted-foreground max-w-xl mx-auto">
              Aureon is $18/month, Asherin Pro is $399/month. Bring your own key on
