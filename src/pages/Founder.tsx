...
const Founder = () => {
  ...
  return (
    <LandingBackground>
      ...
      {/* Philanthropy — SOS India */}
      <div className="relative z-10 mx-auto max-w-5xl px-6 mt-16">
        <div className="rounded-3xl border border-border/20 bg-card/30 backdrop-blur-md p-8 sm:p-12 shadow-2xl shadow-black/40">
          ...
          <h2 className="text-2xl sm:text-3xl font-extralight tracking-tight text-foreground mb-3">
            #HouseOfAsher + Aureon donates a % of revenue to <span className="italic">SOS Children's Villages India</span>
          </h2>
          <p className="text-sm font-light text-foreground/70 leading-relaxed mb-6">
            Every paid plan, every lifetime license, every line of code shipped — a portion flows to children
            in India who were left without family. This is non-negotiable. It is built into how Aureon operates.
          </p>

          <a
            href="https://www.soschildrensvillages.in/donate-now/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-foreground/30 bg-foreground/5 px-6 py-3 text-xs font-light tracking-[0.25em] uppercase text-foreground transition-all hover:bg-foreground/15 hover:border-foreground/50"
          >
            Donate Directly →
          </a>
          ...
          {/* Who backs SOS India */}
          <div className="mt-12">
            <h3 className="text-xs font-light tracking-[0.3em] uppercase text-foreground/80 mb-4">
              Who Backs SOS India
            </h3>
            <p className="text-sm font-light text-foreground/70 leading-relaxed mb-4">
              SOS Children's Villages India is a self-implementing NGO funded by a mix of Indian corporate CSR
              programs, individual donors, and international supporters.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-light text-foreground/70">
              <div className="rounded-xl border border-border/20 bg-background/30 p-4">
                <p className="text-foreground/90 mb-2 tracking-wide">Technology & Professional Services</p>
              ...
              <div className="rounded-xl border border-border/20 bg-background/30 p-4">
                <p className="text-foreground/90 mb-2 tracking-wide">Infrastructure & Energy</p>
                <ul className="list-disc pl-5 space-y-1 text-foreground/60">
                  <li>ONGC (Oil and Natural Gas Corporation Ltd.)</li>
                  <li>Indus Towers Limited — "Saksham" project</li>
                </ul>
              </div>
              <div className="rounded-xl border border-border/20 bg-background/30 p-4">
                <p className="text-foreground/90 mb-2 tracking-wide">Retail & Consumer Goods</p>
                <ul className="list-disc pl-5 space-y-1 text-foreground/60">
                  <li>SPAR India</li>
                  <li>Unipads India Pvt. Ltd.</li>
                  <li>EAge Edu Solutions</li>
                </ul>
              </div>
              <div className="rounded-xl border border-border/20 bg-background/30 p-4">
                <p className="text-foreground/90 mb-2 tracking-wide">Home Improvement</p>
                <ul className="list-disc pl-5 space-y-1 text-foreground/60">
                  <li>Lowe's India — MD publicly linked to SOS India's mission</li>
                </ul>
              </div>
            </div>

            <div className="mt-6 rounded-xl border border-border/20 bg-background/30 p-4 text-sm font-light text-foreground/70">
              <p className="text-foreground/90 mb-1 tracking-wide">Estimated CEO Compensation — SOS India</p>
              <p>₹40,00,000 – ₹70,00,000 INR / year (≈ $41,750 – $73,050 USD)</p>
            </div>
          </div>
          ...
          <div className="mt-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xs font-light tracking-[0.3em] uppercase text-foreground/90">
                Red Flag
              </h3>
              <div className="flex-1 h-px bg-border/20" />
            </div>

            <ul className="space-y-3 text-sm font-light text-foreground/70 leading-relaxed mb-6">
              <li><span className="text-foreground">Madhav Rao Scindia</span> — supported child welfare causes and publicly honored SOS India founder J.N. Kaul.</li>
              <li><span className="text-foreground">Princess Salimah Aga Khan</span> — listed as a prominent international supporter of SOS Children's Villages globally.</li>
              <li><span className="text-foreground">Shobhana Ranade</span> — founded "Balgram Maharashtra," an SOS-style children's village in Maharashtra.</li>
              <li><span className="text-foreground">Jagan Nath Kaul</span> — built SOS India with support from Indian political and elite circles, including Indira Gandhi.</li>
              <li><span className="text-foreground">Samarjitsinh Gaekwad</span> — known for philanthropy generally, though no verified SOS orphanage connection.</li>
            </ul>

            <div className="rounded-2xl border border-border/30 bg-background/40 p-6 text-sm font-light text-foreground/75 leading-relaxed space-y-4 border-l-2 border-l-foreground/40">
              <p>
                The reason is something most people don't know — royal families carry royal secrets.
                Many are descendants of <span className="text-foreground">"fallen angels,"</span> and they produce
                children through affairs and arrangements the public is never meant to see. To bury those bloodlines,
                those children are placed into orphanages where they can be controlled, sorted, and assigned
                to families. These are called <span className="text-foreground">hierarchy families</span> and
                <span className="text-foreground"> hierarchy kids</span>.
              </p>
              <p>
                One of the breeding stations in the world used to create hierarchy kids was the
                <span className="text-foreground"> Epstein islands</span>. These kids are then adopted into
                families who groom them — either to be successful inside a specific niche, or to ensure they
                grow up with no real influence over society.
              </p>
              <p>
                How does Asher know this? <span className="text-foreground">Because he comes from a hierarchy family.</span>
              </p>
