...
/**
 * /blog/venice-integration — long-form post on how Aureon wires the
...
const BlogVeniceIntegration = () => {
  useEffect(() => {
    ...
    el.textContent = JSON.stringify({
      ...
      "@type": "Article",
      headline:
        "Venice AI integration in Aureon — unfiltered intelligence with zero setup",
      description:
        "How Aureon routes free-tier and BYOK traffic through Venice AI so operators get uncensored, vision-capable answers without configuring a Venice key.",
      ...
      <article className="mx-auto max-w-3xl px-6 pt-32 pb-24">
        ...
        <header className="mb-12">
          ...
          <p className="mt-6 text-lg font-extralight leading-relaxed text-foreground/75">
            ...
            thing: an honest model that does not lecture them. Aureon ships that on day one — no
        ...
        <section className="space-y-6 text-base font-extralight leading-[1.8] text-foreground/80">
          ...
          <p>
            When a non-admin operator opens Aureon and has not added their own provider key, the
            ...
            a power user would pick if they were wiring Venice up themselves. The Aureon platform
          ...
          <p>
            ...
            OpenRouter — Aureon uses it. The Venice fallback exists to keep the &ldquo;no setup&rdquo;
          ...
          <p>
            ...
            forensic reconstructions do not collapse into refusals halfway through. Aureon&rsquo;s
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Same Aureon UI, Personas, Project Folders, and OSINT tooling on top.</li>
          </ul>
