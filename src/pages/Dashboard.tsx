    ...
    switch (activeView) {
      ...
      case "pattern-analysis":
        return gatedView(
          ...
          "Data pattern recognition with visual graph forecasting. Available on Asherin Pro.",
        );
      case "zerlal":
        return gatedView(
          "zerlal",
          ZerlalView,
          "asherin.cyber",
          "Passive domain reconnaissance and public advisory context. Available on Asherin Pro.",
        );
      case "google":
        return gatedView(
          "google",
