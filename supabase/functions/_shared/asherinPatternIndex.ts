...
export const ASHERIN_PATTERN_CARDS: PatternCard[] = [
  ...
  {"id":"intel-map-operator","fire_when":["map","property","fly to","roof","street camera"],"never":["Palantir chrome","brand wordmark on the map"],"tools":["intel_map"],"procedure":"Glass-morphic dark operator map, auto-open. Property fly = z19 + public-index dossier. Auto-pull public street cameras. Canvas is pin roster not live tiles."},
