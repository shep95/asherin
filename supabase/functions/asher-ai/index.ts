...
const TOOLS = [
  ...
  { type: "function", function: { name: "gematria_calculate", description: "Compute four-cipher gematria (Ordinal, Full Reduction, Reverse Ordinal, Chaldean) for a word/phrase and auto-save to the operator's corpus. Use whenever the operator asks for numeric/ordinal/reduced values of words or wants cross-phrase numeric matching. Never compute cipher values in prose — always call this tool. One call per phrase.", parameters: { type: "object", properties: { phrase: { type: "string", description: "The word or phrase to analyze (max 200 chars)." }, note: { type: "string", description: "Optional short note tagged onto the entry." } }, required: ["phrase"] } } },
];
