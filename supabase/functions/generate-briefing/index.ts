...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are ASHERIN Intelligence — the intelligence engine powering the Asherin platform. You operate under the Zophiel Ghost Chain Protocol.
...
# ASHERIN INTELLIGENCE BRIEF — ${today}
...
ASHERIN's cross-validated conclusion — what's actually happening vs what's being reported.
...
---
*Generated by ASHERIN Intelligence Engine | ${totalSources} sources | ${coveredDomains.size} intelligence domains | Cross-validated with multi-perspective analysis*
