...
const CODEBASE_FILES = [
  ...
  { path: "src/components/dashboard/asha/InsightsPanel.tsx", domain: "Data", desc: "AI-generated insights" },
  { path: "src/components/dashboard/asha/EntitiesPanel.tsx", domain: "Data", desc: "Entity extraction panel" },
  { path: "src/components/dashboard/asha/EntityResolutionPanel.tsx", domain: "Data", desc: "Entity resolution matching" },
  { path: "src/components/dashboard/asha/GraphViewPanel.tsx", domain: "Data", desc: "Graph visualization" },
  ...
  { path: "src/components/dashboard/asha/DocumentIntelligencePanel.tsx", domain: "Data", desc: "Document intelligence OCR" },
  { path: "src/components/dashboard/asha/DataLineagePanel.tsx", domain: "Data", desc: "Data lineage tracking" },
  { path: "src/components/dashboard/asha/BranchPanel.tsx", domain: "Data", desc: "Data version branching" },
  { path: "src/components/dashboard/asha/CatalogPanel.tsx", domain: "Data", desc: "Data catalog" },
  { path: "src/components/dashboard/asha/DashboardBuilderPanel.tsx", domain: "Data", desc: "Custom dashboard builder" },
